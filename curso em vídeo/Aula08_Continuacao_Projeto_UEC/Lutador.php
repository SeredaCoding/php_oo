...
class Lutador {
    ...
    private function setCategoria() {
        if($this->getPeso() < 52.2){
            $this->categoria = "inválido, por pouco peso";
            ...
            $this->categoria = "inválido, por peso em excesso";
        }
    ...
    public function ganharLuta(){
        ...
        echo "<br>A luta foi ganha! Vitória de: {$this->getNome()}<br>";
    }
    
    public function perderLuta(){
        $this->setDerrotas($this->getDerrotas() + 1);
        echo "<br>A luta foi perdida! Derrota de: {$this->getNome()}<br>";
    }
